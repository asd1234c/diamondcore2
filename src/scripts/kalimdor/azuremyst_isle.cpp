...
struct npc_geezleAI : public ScriptedAI
{
    ...
    void CompleteQuest()
    {
        ...
        Diamond::AnyPlayerInObjectRangeCheck checker(m_creature, radius);
        Diamond::PlayerListSearcher<Diamond::AnyPlayerInObjectRangeCheck> searcher(m_creature, players, checker);
