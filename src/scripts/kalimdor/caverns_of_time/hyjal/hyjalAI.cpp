...
void hyjalAI::HideNearPos(float x, float y)
{
    ...
    Diamond::AllFriendlyCreaturesInGrid creature_check(m_creature);
    Diamond::CreatureListSearcher<Diamond::AllFriendlyCreaturesInGrid> creature_searcher(m_creature, creatures, creature_check);
    TypeContainerVisitor
        <Diamond::CreatureListSearcher<Diamond::AllFriendlyCreaturesInGrid>,
...
void hyjalAI::RespawnNearPos(float x, float y)
{
    ...
    Diamond::WorldObjectWorker<Diamond::RespawnDo> worker(m_creature, u_do);
