...
struct npc_ebon_gargoyleAI : CasterAI
{
    ...
    void InitializeAI()
    {
        ...
        Diamond::AnyUnfriendlyUnitInObjectRangeCheck u_check(m_creature, m_creature, 30);
        Diamond::UnitListSearcher<Diamond::AnyUnfriendlyUnitInObjectRangeCheck> searcher(m_creature, targets, u_check);
