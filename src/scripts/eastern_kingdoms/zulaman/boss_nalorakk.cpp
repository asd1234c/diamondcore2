...
struct boss_nalorakkAI : public ScriptedAI
{
    ...
    void SendAttacker(Unit *pTarget)
    {
...

        {
            ...
            Diamond::AllFriendlyCreaturesInGrid check(m_creature);
            Diamond::CreatureListSearcher<Diamond::AllFriendlyCreaturesInGrid> searcher(m_creature, templist, check);

            TypeContainerVisitor<Diamond::CreatureListSearcher<Diamond::AllFriendlyCreaturesInGrid>, GridTypeMapContainer> cSearcher(searcher);
